      ...
      >
        ...
        <div
          className={cn(
            ...
            "bg-sidebar/80 text-sidebar-foreground w-[--sidebar-width] backdrop-blur-xl",
            side === "left"
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-y-1 overflow-auto group-data-[collapsible=icon]:overflow-hidden p-3",
        className
      )}
      {...props}
    />
